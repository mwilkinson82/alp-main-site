  ...
  return (
    <>
      <SEO
        ...
        keywords="business blog, leadership insights, sales strategies, entrepreneur tips, Marshall Wilkinson blog"
        canonical="/blog"
      />
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              <h1 className="text-4xl md:text-5xl font-bold mb-6">
                <span className="text-primary">ALP</span> Insights
              </h1>
              <p className="text-xl text-muted-foreground">
                Business strategies, leadership wisdom, and proven frameworks to elevate your game.
              </p>
            </div>
          </div>
        </section>
