  ...
  return (
    <>
      <SEO 
        ...
        description="Generate leads. Close deals. Grow revenue. The Sales & Marketing School from Marshall Wilkinson teaches you how to build a real marketing machine for your business. $497/mo or lock in your quarter for $1,341."
                ...
                <div className="grid md:grid-cols-2 gap-6 max-w-2xl mx-auto">
                  ...
                  <div className="border border-border rounded-lg p-6 space-y-4">
                    ...
                    <Button 
                      ...
                      className="w-full"
                    >
                      <a href="https://buy.stripe.com/dRm4gAe0hg9w1Ru4n8eQM14" target="_blank" rel="noopener noreferrer">
                        Subscribe Monthly
                      </a>
                    </Button>
                  </div>
