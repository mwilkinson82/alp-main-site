  ...
  return (
    <>
      <SEO 
        ...
        description="Scale your construction company the right way with Contractor School from Marshall Wilkinson. Live weekly training on estimating, project management, legal, accounting, and operations. $497/mo or lock in your quarter for $1,341."
        keywords="Contractor School, construction business training, construction owners, Marshall Wilkinson, builder training, construction estimating, project management"
