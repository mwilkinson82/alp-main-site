      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-12 space-y-4">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
            Marshall Wilkinson has operated inside high-stakes environments where execution wasn't optional. He has advised on and executed $5B+ in outcomes, building systems that protect margin, create leverage, and scale operations without chaos. ALP is infrastructure for decisive operators.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-16">
          ...
          <div className="space-y-6">
            <div className="text-lg text-foreground space-y-4">
              <p>
                Marshall Wilkinson is an architect of decisions and systems that win. With $5B+ in executed projects and negotiated outcomes, he built his reputation inside environments where failure wasn't tolerated — and results were measured.
              </p>
              <p>
