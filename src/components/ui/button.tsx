  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        premium: "bg-gradient-gold text-primary-foreground hover:shadow-gold transition-smooth shadow-lg font-bold",
        hero: "bg-secondary text-secondary-foreground hover:bg-secondary/90 border-2 border-primary/20 hover:border-primary transition-smooth shadow-elegant text-base",
      },
      size: {
