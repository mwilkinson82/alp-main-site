      ...
      <div className="container mx-auto px-4">
              ...
              >
                ...
                <CardContent className="p-6 md:p-8 space-y-5">
                  ...
                  <div className="flex items-center gap-1.5 text-xs text-muted-foreground">
                    ...
                    <span>Conducted via Zoom — virtual, 1-on-1</span>
                  </div>
                  <Button
        ...
        <div className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground text-sm">Daily and weekly virtual sessions through the ALP portal — built to sharpen decision-making and install scalable business systems.</p>
            <div className="flex items-center justify-center gap-1.5 text-xs text-muted-foreground mt-2">
              <Monitor className="w-3.5 h-3.5" />
              <span>All sessions are virtual — delivered live through the ALP portal</span>
            </div>
          </div>
          <div
